...
//                .logoutRequestMatcher(new AntPathRequestMatcher("/members/logout"))
        ...
        http.antMatcher("/admin/**")
                ...
                .permitAll()
                .mvcMatchers("/admin", "/admin/login", "/admin/item", "/admin/item/**", "/admin/category", "/admin/category/**", "/admin/topic", "/admin/topic/**", "/admin/banner" , "/admin/banner/**")
                .permitAll()
                .anyRequest()
                .authenticated()
        ;
...
//                .logoutRequestMatcher(new AntPathRequestMatcher("/members/logout"))
        ...
        http.antMatcher("/**")
                ...
                .permitAll()
                .mvcMatchers(HttpMethod.GET, "/item", "/item/**", "/category/**", "/topic/**", "/banner/**")
                .permitAll()
